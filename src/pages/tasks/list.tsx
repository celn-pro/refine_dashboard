...
const List = ({children}: React.PropsWithChildren) => {
    ...
    const handelAddCard = (args: {stageId: string})=> {
    ...
    if(isLoading) return <PageSkeletone />
            ...
            <KanbanBoardContainer>
                <KanbanBoard onDragEnd={handleOnDragEnd}>
                    <KanbanColumn
                        ...
                        onAddClick={() => handelAddCard({stageId: 'unassigned' })}
                    >
                        ...
                        {!taskStages.unassignedStage.length && (
                            <KanbanAddCardButton 
                                onClick = {() => handelAddCard({stageId: 'unassigned'})}
                            />
                        )}
                    </KanbanColumn>
                    ...
                    {taskStages.columns?.map((column) => (
                        <KanbanColumn 
                            ...
                            onAddClick={() => handelAddCard({stageId: column.id})}
                        >
                            ...
                            {!column.tasks.length && (
                                <KanbanAddCardButton 
                                onClick = {() => handelAddCard({stageId: column.id})}
                            />
                            )}
                        </KanbanColumn>
                    ))}
